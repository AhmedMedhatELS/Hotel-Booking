...
namespace Hotels_Booking.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            //return list of the states with counteries
            ViewData["states"] = _unitOfWork.States.Get(null,c => c.Country).ToList();
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.StateId != user.StateId)
            {
                ...
                if (!updateResult.Succeeded)
                {
                    StatusMessage = "Unexpected error when trying to update your State.";
                    return RedirectToPage();
                }
            }
